...
<div class="lg:ml-64 min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-3 mt-0.5">
                        <p class="text-sm text-slate-400">Organize and manage ticket categories</p>
            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="relative" id="quickActionsDropdown">
                    ...
                    <div class="absolute right-0 mt-2 w-56 bg-slate-800 rounded-lg shadow-xl border border-slate-700/50 hidden z-50" id="quickActionsMenu">
                        <div class="py-2">
                            <a href="add_category.php" class="flex items-center px-4 py-2 text-sm text-slate-300 hover:bg-slate-700/50 hover:text-cyan-400 transition">
                                <i class="fas fa-plus-circle w-5"></i>
                                <span class="ml-3">Add Category</span>
                            </a>
                            <a href="manage_categories.php" class="flex items-center px-4 py-2 text-sm text-slate-300 hover:bg-slate-700/50 hover:text-cyan-400 transition">
                                <i class="fas fa-edit w-5"></i>
                                <span class="ml-3">Manage All</span>
                            </a>
                            <div class="border-t border-slate-700/50 my-1"></div>
                            <a href="#" class="flex items-center px-4 py-2 text-sm text-slate-300 hover:bg-slate-700/50 hover:text-cyan-400 transition" onclick="viewCategoryStats(); return false;">
                                <i class="fas fa-chart-bar w-5"></i>
                                <span class="ml-3">View Statistics</span>
                            </a>
                            <a href="#" class="flex items-center px-4 py-2 text-sm text-slate-300 hover:bg-slate-700/50 hover:text-cyan-400 transition" onclick="printCategories(); return false;">
    ...
    <div class="p-8">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-slate-300">Categories</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800/50 border border-slate-700/50 p-6 hover:border-cyan-500/50 transition rounded-lg">
                <div class="flex items-start justify-between mb-4">
                    ...
                    <span class="px-3 py-1 text-xs font-medium border border-slate-600 text-slate-300">
                        <?php echo $category['ticket_count']; ?> tickets
                    </span>
                </div>
                <h3 class="text-lg font-semibold text-white mb-2"><?php echo htmlspecialchars($category['name']); ?></h3>
                <div class="flex items-center justify-between text-sm">
                    <span class="text-slate-400">Open Tickets:</span>
                    <span class="font-semibold text-white"><?php echo $category['open_tickets']; ?></span>
                </div>
            </div>
            <?php endforeach; ?>
        </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        window.viewCategoryStats = function() {
            ...
            categoryCards.forEach(card => {
                ...
                const openCount = card.querySelector('.font-semibold.text-white').textContent;
