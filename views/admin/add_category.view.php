...
$pageTitle = 'Add Category - ' . (defined('APP_NAME') ? APP_NAME : 'ServiceHub');
$baseUrl = '../';
    ...
    <div class="bg-white border-b border-slate-200 ">
        <div class="flex items-center justify-between px-4 lg:px-8 py-4 pt-20 lg:pt-4">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-xl lg:text-2xl font-semibold text-slate-800">Add New Category</h1>
                    <p class="text-sm text-slate-500 mt-0.5">Create a new ticket category</p>
                </div>
            </div>
    ...
    <div class="p-8">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="categories.php" class="ml-1 text-sm font-medium text-slate-500 hover:text-emerald-600">Categories</a>
                    </div>
                </li>
                <li>
                    <div class="flex items-center">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white border border-slate-200  p-6">
                <h2 class="text-lg font-semibold text-slate-800 mb-6 pb-3 border-b border-slate-200">
                ...
                <form action="add_category.php" method="POST" class="space-y-6" id="addCategoryForm">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            name="name" 
                            required
                            class="w-full px-4 py-3 border border-gray-300 bg-slate-50 text-slate-800 placeholder-slate-400 focus:ring-2 focus:ring-cyan-500 focus:border-transparent"
                    ...
                    <!-- Icon Selection -->
                    <div>
                        <label for="icon" class="block text-sm font-medium text-slate-800 mb-2">
                            Icon
                        </label>
                        <div class="flex items-center space-x-3">
                            <select 
                                id="icon" 
                                name="icon"
                                class="flex-1 px-4 py-3 border border-gray-300 bg-slate-50 text-slate-800 focus:ring-2 focus:ring-cyan-500 focus:border-transparent"
                            ...
                            <div class="w-12 h-12 border border-gray-300 flex items-center justify-center bg-slate-50 rounded-lg" id="iconPreview">
                    ...
                    <!-- Color Selection -->
                    <div>
                        <label for="color" class="block text-sm font-medium text-slate-800 mb-2">
                            Color
                        </label>
                        <div class="grid grid-cols-8 gap-2 mb-3">
                            ...
                            <button 
                                type="button" 
                                class="w-10 h-10 border-2 border-gray-300 hover:border-emerald-500 transition color-btn rounded-lg"
                    ...
                    <div class="flex items-center justify-end space-x-4 pt-6 border-t border-slate-200">
                        <a href="categories.php" class="px-6 py-3 border border-gray-300 text-gray-700 hover:bg-slate-50 hover:text-slate-800 transition">
            ...
            <div class="bg-white border border-slate-200  p-6">
                ...
                <!-- Preview Card -->
                <div class="border border-slate-200 bg-slate-100/20 p-4 hover:border-emerald-500/50 transition-colors rounded-lg">
                    <div class="flex items-center space-x-3 mb-3">
                        <div class="w-10 h-10 flex items-center justify-center rounded-lg" id="previewIconContainer">
                            <i class="fas fa-folder text-slate-500 text-xl" id="previewIcon"></i>
                        </div>
                        <div class="flex-1">
                            <h3 class="font-semibold text-slate-800" id="previewName">Category Name</h3>
                            <p class="text-xs text-slate-500 mt-0.5" id="previewDescription">No description yet</p>
                        </div>
                    </div>
                    <div class="border-t border-slate-200 pt-3 mt-3">
                        <div class="flex items-center justify-between text-sm">
                            <span class="text-slate-500">Sample Tickets:</span>
                ...
                <div class="mt-6 bg-white border border-slate-200 p-4 rounded-lg">
                ...
                <!-- Help Section -->
                <div class="mt-6 bg-emerald-50 border border-emerald-600/50 p-4 rounded-lg">
                    <h3 class="text-sm font-semibold text-emerald-600 mb-3">
                        <i class="fas fa-info-circle mr-1"></i>Best Practices
                    </h3>
                    <ul class="space-y-2 text-sm text-teal-500">
