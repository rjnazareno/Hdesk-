    ...
    <div class="bg-white border-b border-gray-200 ">
        <div class="flex items-center justify-between px-4 lg:px-8 py-4 pt-20 lg:pt-4">
            ...
            <div class="flex items-center space-x-4">
                <a href="customers.php" class="lg:hidden text-gray-600 hover:text-gray-900">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600">Update employee information</p>
                </div>
            </div>

            <!-- Right Section: Actions -->
            <div class="flex items-center space-x-3">
                <a href="customers.php" class="hidden lg:flex items-center px-4 py-2 border border-gray-300 bg-gray-50 text-gray-700 hover:bg-gray-100 hover:text-gray-900 transition rounded-lg">
        ...
        <div class="max-w-4xl">
            <form method="POST" action="" class="space-y-6">
                    ...
                    <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   ...
                                   required
                                   class="w-full px-4 py-2 bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent">
                        </div>
                ...
                <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                    <a href="customers.php" class="px-6 py-2.5 border border-gray-300 bg-gray-50 text-gray-700 hover:bg-gray-100 hover:text-gray-900 transition rounded-lg">
                        <i class="fas fa-times mr-2"></i>
                        Cancel
                    </a>
                    <button type="submit" class="px-6 py-2.5 bg-gradient-to-r from-teal-500 to-emerald-600 text-gray-900 hover:from-teal-700 hover:to-emerald-700 transition rounded-lg">
