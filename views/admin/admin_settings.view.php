<?php
$pageTitle = 'Admin Settings - ' . (defined('APP_NAME') ? APP_NAME : 'ServiceHub');
$baseUrl = '../';
?>
<?php include __DIR__ . '/../layouts/header.php'; ?>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-3 mt-0.5">
                            <p class="text-sm text-slate-500">Manage system users and settings</p>
                            <span class="hidden md:inline-flex items-center px-2 py-0.5 text-xs font-medium border border-gray-300 text-gray-700 bg-slate-100/30 rounded">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div class="hidden md:block relative">
                        <input 
                            ...
                            class="pl-10 pr-4 py-2 w-48 lg:w-64 border border-gray-300 bg-slate-50 text-slate-800 placeholder-slate-400 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent text-sm transition-all"
                            id="quickSearch"
                        >
                    ...
                    <div class="relative" id="quickActionsDropdown">
                        <button class="flex items-center space-x-2 px-4 py-2 border border-gray-300 bg-slate-50 text-gray-700 hover:text-slate-800 hover:border-emerald-500/50 rounded-lg transition" id="quickActionsBtn">
                            <i class="fas fa-bolt text-cyan-500"></i>
                            <span class="hidden lg:inline text-sm font-medium">Quick Actions</span>
                            <i class="fas fa-chevron-down text-xs"></i>
                        </button>
                        <div class="absolute right-0 mt-2 w-56 bg-slate-100 rounded-lg shadow-xl border border-slate-200 hidden z-50" id="quickActionsMenu">
                            <div class="py-2">
                                <a href="#" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-slate-50 hover:text-emerald-600 transition" onclick="openAddUserModal('it_staff'); return false;">
                                    <i class="fas fa-user-plus w-5 text-cyan-500"></i>
                                    <span class="ml-3">Add IT Staff</span>
                                </a>
                                <a href="#" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-slate-50 hover:text-emerald-600 transition" onclick="openAddUserModal('user'); return false;">
                                    <i class="fas fa-user w-5 text-emerald-500"></i>
                                    <span class="ml-3">Add User</span>
                                </a>
                                <div class="border-t border-slate-200 my-1"></div>
                                <a href="#" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-slate-50 hover:text-emerald-600 transition" onclick="exportUserList(); return false;">
                                    <i class="fas fa-file-export w-5 text-emerald-500"></i>
                                    <span class="ml-3">Export Users</span>
                                </a>
                                <a href="#" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-slate-50 hover:text-emerald-600 transition" onclick="viewAuditLog(); return false;">
                    ...
                    <div class="relative" id="notificationDropdown">
                        <button class="relative p-2 text-slate-500 hover:text-slate-800 hover:bg-slate-50 rounded-lg transition" title="Notifications" id="notificationBell">
                            <i class="far fa-bell text-lg"></i>
                            <span class="absolute top-1 right-1 w-2 h-2 bg-red-500 rounded-full animate-pulse"></span>
                        </button>
                        <div class="absolute right-0 mt-2 w-80 bg-slate-100 rounded-lg shadow-xl border border-slate-200 hidden z-50" id="notificationMenu">
                            <div class="p-4 border-b border-slate-200 flex items-center justify-between">
                                <h3 class="font-semibold text-slate-800">Notifications</h3>
                                <span class="text-xs text-slate-500">3 new</span>
                            </div>
                            <div class="max-h-96 overflow-y-auto">
                                <!-- Notification Items -->
                                <a href="#" class="block px-4 py-3 hover:bg-slate-50 border-b border-slate-200 transition">
                                    <div class="flex items-start space-x-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <p class="text-sm font-medium text-slate-800">New ticket submitted</p>
                                            <p class="text-xs text-slate-500 mt-1">John Doe submitted a new hardware issue</p>
                                ...
                                <a href="#" class="block px-4 py-3 hover:bg-slate-50 border-b border-slate-200 transition">
                                    <div class="flex items-start space-x-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <p class="text-xs text-slate-500 mt-1">Jane Smith registered as a new employee</p>
                                ...
                                <a href="#" class="block px-4 py-3 hover:bg-slate-50 transition">
                                    <div class="flex items-start space-x-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <p class="text-sm font-medium text-slate-800">High priority ticket</p>
                                            <p class="text-xs text-slate-500 mt-1">Network outage reported in Building A</p>
                            ...
                            <div class="p-3 border-t border-slate-200 text-center">
                                <a href="#" class="text-sm text-emerald-600 hover:text-emerald-600 font-medium">View all notifications</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="relative" id="userMenuDropdown">
                        <button class="flex items-center space-x-2 p-1 hover:bg-slate-50 transition" id="userMenuBtn">
                            ...
                            <div class="hidden lg:block text-left">
                                <div class="text-sm font-medium text-slate-800"><?php echo htmlspecialchars(explode(' ', $currentUser['full_name'])[0]); ?></div>
                                <div class="text-xs text-slate-500"><?php echo ucfirst(str_replace('_', ' ', $currentUser['role'])); ?></div>
                            </div>
                            <i class="fas fa-chevron-down text-xs text-slate-500 hidden lg:block"></i>
                        </button>
                        <div class="absolute right-0 mt-2 w-64 bg-slate-100 border border-slate-200 hidden z-50" id="userMenu">
                            <div class="p-4 border-b border-slate-200">
                                <div class="font-medium text-slate-800"><?php echo htmlspecialchars($currentUser['full_name']); ?></div>
                                <div class="text-sm text-slate-500"><?php echo htmlspecialchars($currentUser['email']); ?></div>
                                <div class="mt-1">
                                    <span class="inline-flex items-center px-2 py-0.5 text-xs font-medium border border-gray-300 text-gray-700 bg-slate-100/30">
                                        <i class="fas fa-crown mr-1"></i>
                            ...
                            <div class="py-2">
                                <a href="profile.php" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-slate-50 hover:text-emerald-600 transition">
                                    <i class="fas fa-user w-5"></i>
                                    <span class="ml-3">My Profile</span>
                                </a>
                                <a href="dashboard.php" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-slate-50 hover:text-emerald-600 transition">
            ...
            <div class="md:hidden px-4 pb-4">
                <div class="relative">
                    <input 
                        type="text" 
                        placeholder="Search users..." 
                        class="w-full pl-10 pr-4 py-2 border border-gray-300 bg-slate-50 text-slate-800 placeholder-slate-400 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent text-sm"
        ...
        <div class="p-8">
            ...
            <div class="bg-white rounded-lg border border-slate-200 mb-6 overflow-hidden">
                <div class="p-6 border-b border-slate-200">
                    <h3 class="text-lg font-semibold text-slate-800">IT Staff & Admin Management</h3>
                    <p class="text-slate-500 text-sm">Manage system administrators and IT staff</p>
                </div>
                <div class="p-6">
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <thead>
                                <tr class="text-left text-slate-500 text-sm border-b border-slate-200">
                                    <th class="pb-3">ID</th>
                            ...
                            <tbody class="text-sm">
                                ...
                                <tr class="border-b border-slate-200 hover:bg-slate-100/30">
                                    <td class="py-4 text-slate-800"><?php echo $user['id']; ?></td>
                                    <td class="py-4">
                                        <span class="font-medium text-slate-800"><?php echo htmlspecialchars($user['username']); ?></span>
                                    </td>
                                    <td class="py-4 text-gray-700"><?php echo htmlspecialchars($user['full_name']); ?></td>
                                    <td class="py-4 text-slate-500"><?php echo htmlspecialchars($user['email']); ?></td>
                                    <td class="py-4">
                                        <?php
                                        $roleColors = [
                                            'admin' => 'bg-purple-600 text-white',
                                            'it_staff' => 'bg-blue-600 text-white',
                                            'internal' => 'bg-emerald-600 text-white'
                                        ];
                                        $roleClass = $roleColors[$user['role']] ?? 'bg-slate-100 text-slate-200';
                                        ?>
                                        <span class="px-2 py-1 rounded-full text-xs font-medium <?php echo $roleClass; ?>">
                                            <?php echo ucfirst(str_replace('_', ' ', $user['role'])); ?>
                                        </span>
                                    </td>
                                    <td class="py-4 text-gray-700"><?php echo htmlspecialchars($user['department'] ?? '-'); ?></td>
                                    <td class="py-4">
                                        <?php if ($user['is_active']): ?>
                                            <span class="px-2 py-1 rounded-full text-xs font-medium bg-emerald-600 text-slate-800">Active</span>
                                        <?php else: ?>
                                            <span class="px-2 py-1 rounded-full text-xs font-medium bg-red-600 text-slate-800">Inactive</span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="py-4">
                                        <div class="flex items-center space-x-2">
                                            <button onclick="openEditModal(<?php echo htmlspecialchars(json_encode($user)); ?>)" 
                                                    class="text-emerald-600 hover:text-emerald-600" title="Edit User">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="bg-white rounded-lg border border-slate-200 p-6 overflow-hidden relative">
                    <div class="absolute inset-0 bg-gradient-to-br from-blue-500/10 to-transparent pointer-events-none"></div>
                    <div class="flex items-center justify-between relative z-10">
                        <div>
                            <p class="text-slate-500 text-sm">Total IT Staff</p>
                            <h3 class="text-2xl font-bold text-slate-800 mt-1"><?php echo count($allUsers); ?></h3>
                        </div>
                ...
                <div class="bg-white rounded-lg border border-slate-200 p-6 overflow-hidden relative">
                    ...
                    <div class="flex items-center justify-between relative z-10">
                        <div>
                            <p class="text-slate-500 text-sm">Active Admins</p>
                ...
                <div class="bg-white rounded-lg border border-slate-200 p-6 overflow-hidden relative">
                    ...
                    <div class="flex items-center justify-between relative z-10">
                        <div>
                            <p class="text-slate-500 text-sm">Active IT Staff</p>
                            <h3 class="text-2xl font-bold text-slate-800 mt-1">
                                <?php 
                                echo count(array_filter($allUsers, function($u) {
    ...
    <!-- Edit User Modal -->
    <div id="editModal" class="hidden fixed inset-0 bg-black/60  overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-lg bg-slate-100 border-slate-200">
            <div class="mt-3">
                <h3 class="text-lg font-medium text-slate-800 mb-4">Edit User Information</h3>
                <form method="POST" id="editForm">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="username" id="edit_username" 
                               class="w-full px-3 py-2 border border-gray-300 bg-slate-50 text-slate-800 placeholder-slate-400 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="role" id="edit_role" 
                                class="w-full px-3 py-2 border border-gray-300 bg-slate-50 text-slate-800 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent">
                            <option value="it_staff">IT Staff</option>
                            <option value="admin">Admin</option>
                            <option value="internal">Internal (Employee with Admin Access)</option>
                        </select>
                    </div>
                    ...
                    <div class="flex justify-end space-x-2">
                        <button type="button" onclick="closeEditModal()" 
                                class="px-4 py-2 bg-slate-50 text-gray-700 border border-gray-300 rounded-lg hover:bg-slate-100 hover:text-slate-800 transition">
                            Cancel
                        </button>
                        <button type="submit" 
                                class="px-4 py-2 bg-gradient-to-r from-emerald-400 to-emerald-600 text-slate-800 rounded-lg hover:from-teal-700 hover:to-emerald-700 transition">
                            Save Changes
                        </button>
                    </div>
                </form>
    ...
    <div id="passwordModal" class="hidden fixed inset-0 bg-black/60  overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-lg bg-slate-100 border-slate-200">
            <div class="mt-3">
                <h3 class="text-lg font-medium text-slate-800 mb-4">Change Password</h3>
                <p class="text-sm text-slate-500 mb-4">Changing password for: <strong id="password_username" class="text-slate-800"></strong></p>
                <form method="POST" id="passwordForm">
                    ...
                    <div class="flex justify-end space-x-2">
                        ...
                        <button type="submit" 
                                class="px-4 py-2 bg-emerald-600 text-slate-800 rounded-lg hover:bg-emerald-700 transition">
                            Change Password
                        </button>
                    </div>
                </form>
