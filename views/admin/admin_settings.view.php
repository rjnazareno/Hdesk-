                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div class="relative" id="quickActionsDropdown">
                        ...
                        <div class="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-gray-200 hidden z-50" id="quickActionsMenu">
                            <div class="py-2">
                                <a href="#" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-700 transition" onclick="openAddUserModal('it_staff'); return false;">
                                    <i class="fas fa-user-plus w-5 text-blue-600"></i>
                                    <span class="ml-3">Add IT Staff</span>
                                </a>
                                <a href="#" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-700 transition" onclick="openAddUserModal('user'); return false;">
                    ...
                    <div class="relative" id="notificationDropdown">
                        ...
                        <div class="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-xl border border-gray-200 hidden z-50" id="notificationMenu">
                                ...
                                <a href="#" class="block px-4 py-3 hover:bg-gray-50 border-b border-gray-100 transition">
                                    <div class="flex items-start space-x-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <p class="text-xs text-gray-500 mt-1">John Doe submitted a new hardware issue</p>
                                ...
                                <a href="#" class="block px-4 py-3 hover:bg-gray-50 border-b border-gray-100 transition">
                                    <div class="flex items-start space-x-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <p class="text-xs text-gray-500 mt-1">Jane Smith registered as a new employee</p>
                                ...
                                <a href="#" class="block px-4 py-3 hover:bg-gray-50 transition">
                                    <div class="flex items-start space-x-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <p class="text-xs text-gray-500 mt-1">Network outage reported in Building A</p>
