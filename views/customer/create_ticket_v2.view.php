        ...
        <div class="p-6 max-w-5xl mx-auto">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <form action="create_ticket.php" method="POST" enctype="multipart/form-data" id="createTicketForm" class="p-8">
                    <input type="hidden" name="form_token" value="<?php echo htmlspecialchars($_SESSION['ticket_form_token'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
        ...
        function goToStep(step) {
            ...
            if (step === 3) {
                ...
                if (selectedLevel1 === 'other' && !document.getElementById('categoryOtherText').value.trim()) {
                    showAlert('Please describe your concern in the "Other" text field', 'warning');
                ...
                if (!categoryId) {
                    ...
                    if (generalParent) {
                        ...
                        // Last resort: first parent in this department (exclude hidden * categories)
