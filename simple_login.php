            ...
            <div class="mt-8 pt-6 border-t border-gray-200">
                ...
                <div class="space-y-2 text-xs">
                    ...
                    <div class="bg-green-50 p-3 rounded-lg">
                        ...
                        <div class="text-green-700">Username: vincent.santos | Password: password123</div>
                        <div class="text-green-600 text-xs mt-1">Also try: shaina.dela cruz, renalyn.josafat</div>
                    </div>
                </div>
            </div>
        </div>
